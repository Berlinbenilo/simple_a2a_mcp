...
from src.agents.unstructured_agent.agent import UnstructuredAgent


class UnstructuredAgentExecutor(AgentExecutor):
    """
    Implements the AgentExecutor interface to integrate the
    unstructured agent with the A2A framework.
    """

    def __init__(self):
        self.agent = UnstructuredAgent()
